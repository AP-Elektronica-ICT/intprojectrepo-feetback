...
/// app bar, see [SliverAppBar], which embeds an [FeetbackAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
///
/// If the [leading] widget is omitted, but the [FeetbackAppBar] is in a [Scaffold] with
...
///
/// This sample shows an [FeetbackAppBar] with two simple actions. The first action
...
/// See also:
///
///  * [Scaffold], which displays the [FeetbackAppBar] in its [Scaffold.appBar] slot.
///  * [SliverAppBar], which uses [FeetbackAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [FeetbackAppBar]
...
class FeetbackAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [FeetbackAppBar] will imply an appropriate widget. For example, if the [FeetbackAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [FeetbackAppBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [FeetbackAppBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [FeetbackAppBar]'s container
  /// changes the [FeetbackAppBar]'s size. A [SliverAppBar] in a [CustomScrollView]
  /// changes the [FeetbackAppBar]'s height when scrolled.
  ///
  ...
  /// Used to specify the height of the app bar.
  /// *** This is custom added for the feetback project ***
  final double height;

  /// Align the content of the app bar.
  /// *** This is custom added for the feetback project ***
  final Alignment contentAlignment;

  /// Padding of the app bar.
  /// It should be noted that the app bar has a fixed height so the content
  /// height + padding should fit in the app bar height.
  /// Also consider the default padding around the leading and trailing icons
  /// this padding is 16dp.
  /// *** This is custom added for the feetback project ***
  ...
  @override
  _FeetbackAppBarState createState() => _FeetbackAppBarState();
}

class _FeetbackAppBarState extends State<FeetbackAppBar> {
...
/// the screen see [FeetbackAppBar], which is used in the [Scaffold.appBar] slot.
///
...
///    scrolling.
///  * [FeetbackAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [FeetbackAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
class SliverAppBar extends StatefulWidget {
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [FeetbackAppBar] will
  /// imply an appropriate widget. For example, if the [FeetbackAppBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [FeetbackAppBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// content is not scrolled under the [FeetbackAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [FeetbackAppBar] is being displayed over content that is scrolled under it.
  ///
